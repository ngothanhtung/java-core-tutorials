...
public class Main {
  public static void main(String[] args) {
    ...
    long salary = 1000000000L; // size = 8 bytes = 64 bits = [-2^63, 2^63 - 1] = [-9223372036854775808,
                               // 9223372036854775807]
    ...
    // Tính 0b1001_0010 sang hệ thập phân, bằng cách nhân lần lượt từ phải sang
    // trái, bắt đầu từ 1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048,
